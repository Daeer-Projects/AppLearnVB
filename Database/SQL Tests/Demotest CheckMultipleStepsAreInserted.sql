...
ALTER PROCEDURE [InsertNewDemonstrationStep].[test CheckMultipleStepsAreInserted]
AS
BEGIN
    SET NOCOUNT ON;
  --Assemble
  ...
  --  For more information, see http://tsqlt.org/user-guide/isolating-dependencies/
    ...
    INSERT  INTO InsertNewDemonstrationStep.Expected
            (ID, DescriptionOfStage, RegEx, StageMark, QuestionID)
    VALUES  (1, 'A very long demo step.', '$/d/s Some reg ex here./s/d/$2', 5, 6),
            (2, 'Another long demo step.', '$/d/s Some more reg ex here./s/d/$2', 5, 6),
            (3, 'Yet another long demo step.', '$/d/s Some more reg ex here./s/d/$2', 5, 6);
