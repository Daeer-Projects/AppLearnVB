...
CREATE PROCEDURE [InsertNewQuestion].[test CheckQuestionInsertedWithNULLSearchString]
AS
BEGIN
    SET NOCOUNT ON;
  --Assemble
  ...
  --  For more information, see http://tsqlt.org/user-guide/isolating-dependencies/
    ...
    VALUES  (
             ...
             NULL, -- NewSearchString - varchar(300)
  ...
  --  and capture the results in variables or tables.
    ...
    EXEC tSQLt.ExpectNoException
        @Message = N'Insert question with NULL search string threw an exception.'; -- nvarchar(max)
